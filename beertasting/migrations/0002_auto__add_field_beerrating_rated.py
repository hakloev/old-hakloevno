...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeerRating.rated'
        db.add_column(u'beertasting_beerrating', 'rated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 6, 6, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeerRating.rated'
        db.delete_column(u'beertasting_beerrating', 'rated')
