...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BeerRating.event'
        db.add_column(u'beertasting_beerrating', 'event',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['beertasting.TastingEvent']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BeerRating.event'
        db.delete_column(u'beertasting_beerrating', 'event_id')
