...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'blog_blogpost', 'title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=23))

    def backwards(self, orm):

        # Changing field 'Blogpost.title'
        db.alter_column(u'blog_blogpost', 'title', self.gf('django.db.models.fields.CharField')(max_length=25, unique=True))
    ...
    models = {
        u'blog.blogpost': {
            ...
            'title': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '23'})
        },
        u'blog.category': {
