...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beer.code'
        db.add_column(u'beertasting_beer', 'code',
                      self.gf('django.db.models.fields.CharField')(default='b39a14eb8abf6a5c1c74a9a576b745a7', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beer.code'
        db.delete_column(u'beertasting_beer', 'code')
